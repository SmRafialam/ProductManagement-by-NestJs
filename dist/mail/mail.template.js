...
exports.getResetTemplate = exports.getInvitationTemplate = void 0;
const getInvitationTemplate = (userName, resetLink) => {
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding:80px 40px 0;" align="center" valign="top" class="mainTitle">
                                                    <h2 class="text" style="color:#000;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:28px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:36px;text-transform:none;text-align:center;padding:0;margin:0">Hi <strong>${userName ? userName : ''}</strong></h2>
                                                </td>
                                            </tr>
                                            <tr>
...
exports.getInvitationTemplate = getInvitationTemplate;
const getResetTemplate = (userName, resetLink) => {
    return `<table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;background-color:#f9f9f9" id="bodyTable">
        <tbody>
            <tr>
                <td style="padding-right:10px;padding-left:10px;" align="center" valign="top" id="bodyCell">
